    ...
    /* Fetch the true Availabilities */

    Availability.getTrueAvailabilities = async () => {
        try {
        const availabilities = await Availability.findAll(); // Fetch all availabilities
        const meetings = await Meeting.findAll(); // Fetch all meetings
    
        // Perform logic to remove overlapping times
        // ... (logic here)
    
        return trueAvailabilities; // Replace this with the actual logic to compute true availabilities
